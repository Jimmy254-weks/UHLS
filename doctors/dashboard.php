...
// Suppress error reporting to avoid displaying errors
error_reporting(0);
...
?>
    ...
    <footer>
        <div class="footer">
            <p>Copyright &copy; <?php echo date("Y"); ?> Designed by James Wekesa & Jo-Anne Khang</p>
        </div>
    </footer>
