...
header {
    ...
    width: 95%;
    background-color: gray;
    z-index: 1000; /* Ensure header is above other content on scrolling */
}
...
footer {
    ...
    width: 100%;
    background-color: gray;
    z-index: 1000; /* Ensure footer is above other content on scrolling */
}
...
<header>
    <nav class="main-nav">
        <ul>
            ...
            <li class="dropdown-container">
                <div class="dropdown-button">Pages</div>
                <ul class="dropdown-content">
...
<div class="container">
    ...
    <div class="row">
        <div class="col">
            <h4 class="title">Between dates reports</h4>
            <?php
            ...
            <table class="table">
                ...
                <tbody>
                    <?php
                    $sql=mysqli_query($conn,"select * from tblpatient where date(CreationDate) between '$fdate' and '$tdate'");
                    $cnt=1;
