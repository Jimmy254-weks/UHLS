...
<div class="container">
    <main>
        <div class="custom-container-fluid">
            <div class="custom-row"><br><br>
                <div class="custom-col-md-12">
                    <h5 class="custom-title">Manage Unread Queries</h5>
                    <table class="custom-table" id="query-table">
                        <thead>
                            <tr>
                                <th class="center">#</th>
                                <th>Name</th>
                        ...
                        <tbody>
                            <?php
                            $sql=mysqli_query($conn,"select * from tblcontactus where IsRead is null");
                            $cnt=1;
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="custom-visible">
                                        <a href="query-details.php?id=<?php echo $row['id'];?>">View</a>
                                    </div>
                                </td>
                            </tr>
                            <?php 
